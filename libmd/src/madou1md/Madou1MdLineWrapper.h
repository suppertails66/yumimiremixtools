#ifndef MADOU1MDLINEWRAPPER_H
#define MADOU1MDLINEWRAPPER_H
...
class Madou1MdLineWrapper : public BlackT::TLineWrapper {
public:
  struct SizeTableEntry {
    int glyphWidth;
    int advanceWidth;
  };
  typedef std::map<int, SizeTableEntry> CharSizeTable;
  
  typedef BlackT::TTwoDArray<int> KerningMatrix;

  Madou1MdLineWrapper(BlackT::TStream& src__,
//                  BlackT::TStream& dst__,
                  ResultCollection& dst__,
                  const BlackT::TThingyTable& thingy__,
                  CharSizeTable sizeTable__ = CharSizeTable(),
